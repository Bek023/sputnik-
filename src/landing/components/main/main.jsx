        ...
        <div className="max-w-5xl space-y-6 md:space-y-10">
          <div className="max-w-2xl space-y-4 md:space-y-6">
            <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold leading-[1.1] tracking-tight">
              Powering Your Home &amp; <br className="hidden sm:block" />{" "}
              Business
            </h1>

            <p className="text-base md:text-xl opacity-90 leading-relaxed font-normal max-w-xl">
              We've built our reputation on reliability, responsiveness, and
              results and we're proud to be the first call for countless
              homeowners, builders, and businesses in Service. Whether you're
              powering up a new space or upgrading outdated systems, you can
              count on Powering your home &amp; business to bring the energy
